...
<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    ...
    <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        <ul class="navbar-nav me-lg-2">
            <li class="nav-item nav-profile dropdown">
                <a class="nav-link show" href="#" data-bs-toggle="dropdown" id="profileDropdown" aria-expanded="true">
                    ...
                    <span class="nav-profile-name">
                        {{ Auth::user()->name }} Premium Patches
                    </span>
                </a>
            ...
            <li class="nav-item">
                <a class="nav-link notifications-dropdown" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" style="background: #08bdc9;line-height: 22px;border-radius: 40px;min-width: 100px;text-align: center;font-weight: 700;">
