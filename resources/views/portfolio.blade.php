      ...
      <div class="breadcrumb-wrapper bg-cover" style="background-image: url('frontend-assets/img/breadcrumb-bg.jpg');">
         ...
         <div class="container">
            <div class="page-heading center">
               <h6>Digitizing - Patches - Raster To Vector</h6>
               <h1>Portfolio</h1>
            </div>
         </div>
      </div>
...
<!-- Portfolio Tabs Section Start -->
@include('sections.portfolio-tabs')

<!-- Portfolio Section Start -->
<section class="project-section fix section-padding section-bg-2 mb-5 pt-0">
