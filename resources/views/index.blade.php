        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5">
                    ...
                    <form id="contact" method="POST" data-route="{{ route('client.store') }}">
                        @csrf
                        ...
                        <fieldset>
                            <input id="phone" name="phone" placeholder="Your Phone Number" type="tel" required>
                        </fieldset>
                        <fieldset>
                            <select id="hero-form" class="form-control" name="service" required>
                        ...
                        <fieldset>
                            <div class="g-recaptcha" data-sitekey="6Lc1JBwrAAAAANDoWwnKx31N9s-M6RBeetB-V_mF"></div>
                        </fieldset>
